...
namespace InnerSourcePortal.Models
{
    public class Owner
    {
    ...
    public class InnerSourceMetadata
    {
        [JsonPropertyName("participation")]
        public List<int> Participation { get; set; }
    ...
    public class Repository
    {
        ...
        [JsonPropertyName("_InnerSourceMetadata")]
        public InnerSourceMetadata InnerSourceMetadata { get; set; }
    }
}
